...
const windowSystems = [
    {systemOption: 'IGLO 5 CLASSIC',
        ...
        handles: [
            ...
            {name: 'Oliwka'},
            {name: 'Czarna'},
            {name: 'Biała z kluczem'},
            {name: 'Biała z kluczem - ATEST'},
            {name: 'Srebrna z kluczem'},
            {name: 'Brązowa z kluczem'},
            {name: 'Oliwka z kluczem'},
            {name: 'Biała z przyciskiem'},
            {name: 'Srebrna z przyciskiem'},
            {name: 'Brązowa z przyciskiem'},
            {name: 'Oliwka z przyciskiem'},
            {name: 'Biała-Hoppe Secustic'},
            {name: 'Srebrna F1 - Hoppe Secustic'},
            {name: 'Brązowa - Hoppe Secustic'},
            {name: 'Oliwka F4 - Hoppe Secustic'},
            {name: 'Tytanowa F9 - Hoppe Secustic'},
            {name: 'Szampańska F2 - Hoppe Secustic'},
            {name: 'Biała z kluczykiem z funkcją TBT'},
            {name: 'Srebrna z kluczykiem z funkcją TBT'},
            {name: 'Brązowa z kluczykiem z funkcją TBT'},
            {name: 'Oliwka z kluczykiem z funkcją TBT'},
            {name: 'Klamka po prawej stronie w oknie U'},
            {name: 'Klamka po lewej stronie w oknie U'},
            {name: 'Klamka MA 1010 stal nierdzewna'},
            {name: 'Klamka DUBLIN - biała RAL9016'},
            {name: 'Klamka DUBLIN - brązowa RAL8019'},
            {name: 'Klamka DUBLIN - srebrna'},
            {name: 'Klamka DUBLIN - czarny mat RAL9005'},
            {name: 'Klamka DUBLIN - antracyt RAL7016'},
            {name: 'Klamka z przyciskiem DUBLIN - biała RAL9016'},
            {name: 'Klamka z przyciskiem DUBLIN - brązowa RAL8019'},
            {name: 'Klamka z przyciskiem DUBLIN - srebrna'},
            {name: 'Klamka z przyciskiem DUBLIN - czarny mat RAL9005'},
            {name: 'Klamka z przyciskiem DUBLIN - antracyt RAL7016'},
            {name: 'Klamka z kluczykiem DUBLIN - biała'},
            {name: 'Klamka z kluczykiem DUBLIN - brązowa'},
            {name: 'Klamka z kluczykiem DUBLIN - srebrna'},
            {name: 'Klamka z kluczykiem DUBLIN - czarny mat RAL9005'},
            {name: 'Klamka z kluczykiem DUBLIN - antracyt RAL7016'},
            {name: 'Klamka płaska biała'},
            {name: 'Klamka płaska brązowa'},
            {name: 'Klamka płaska srebrna'},
            {name: 'Klamka płaska oliwka'},
            {name: 'brak klamki'},
        ],
        profiles: [
            'BIAŁY',
    ...
    types: [
        ...
        profiles: ['BIAŁY', 'BRĄZOWY'],
        doorsteps: [
            'RAMA',
            'PRÓG ALUMINIOWY 20mm'
        ],
        openOption: [
            'do środka'
        ],
    ...
    types: [
        ...
        handles: [
            ...
            {name: 'Tytanowa F9 - Hoppe Secustic'},
            {name: 'Szampańska F2 - Hoppe Secustic'},
            {name: 'Biała z kluczem (IE)'},
            {name: 'Biała z kluczem - Hoppe Secustic'},
            {name: 'Srebrna F1 z kluczem- Hoppe Secustic'},
            {name: 'Brązowa z kluczem - Hoppe Secustic'},
            {name: 'Oliwka F4 z kluczem - Hoppe Secustic'},
            {name: 'Tytanowa F9 z kluczem - Hoppe Secustic'},
            {name: 'Szampańska F2 z kluczem - Hoppe Secustic'},
            {name: 'Biała z przyciskiem Hoppe Secustic'},
            {name: 'Srebrna F1 z przyciskiem- Hoppe Secustic'},
            {name: 'Brązowa z przyciskiem - Hoppe Secustic'},
            {name: 'Oliwka F4 z przyciskiem - Hoppe Secustic'},
            {name: 'Tytanowa F9 z przyciskiem - Hoppe Secustic'},
            {name: 'Szampańska F2  z przyciskiem- Hoppe Secustic'},
            {name: 'Biała z kluczykiem z funcją TBT'},
            {name: 'Srebrna z kluczykiem z funcją TBT'},
            {name: 'Brązowa z kluczykiem z funcją TBT'},
            {name: 'Oliwka z kluczykiem z funcją TBT'},
            {name: 'Klamka po prawej stronie w oknie U'},
            {name: 'Klamka po lewej stronie w oknie U'},
            {name: 'Srebrna klamka z kluczem (IE)'},
            {name: 'Klamka MA 1010 stal nierdzewna'},
            {name: 'Klamka DUBLIN - biała RAL9016'},
            {name: 'Klamka DUBLIN - brązowa RAL8019'},
            {name: 'Klamka DUBLIN - srebrna'},
        ...
        profiles: ['BIAŁY', 'BRĄZOWY', 'ANTRACYT'],
        openOption: [
            'do środka'
        ],
        brakeOptions: [
    ...
    types: [
        ...
        handles: [
            ...
            {name: 'Brązowa tylko od środka-UP'},
            {name: 'Srebrna tylko od środka-UP'},
            {name: 'Biała z kluczem tylko od środka-UP'},
            {name: 'Brązowa z kluczem tylko od środka-UP'},
            {name: 'Srebrna z kluczem tylko od środka-UP'},
            {name: 'Brak klamki-UP'},
        ],
        profiles: ['BIAŁY'],
        doorsteps: [
    ...
    types: [
        ...
        handles: [
            ...
            {name: 'Brązowa - UP na PP (dwustronna)'},
    ...
    {systemOption: 'IGLO HS',
        ...
        handles: [
            ...
            {name: 'Zew.pochwyt brązowy/wew.klamka biała(HS)'},
            {name: 'Zew.pochwyt srebrny/wew.klamka biała(HS)'},
            {name: 'Zew.pochwyt brązowy/wew.klamka brązowa(HS)'},
            {name: 'Zew.pochwyt srebrny/wew.klamka srebrna(HS)'},
            {name: 'Zew.pochwyt czarny/wew.klamka czarna(HS)'},
            {name: 'Zew.pochwyt czarny/wew.klamka biała(HS)'},
            {name: 'Zew.klamka biała/wew.klamka biała(HS)'},
            {name: 'Zew.klamka brązowa/wew.klamka brązowa(HS)'},
            {name: 'Zew.klamka srebrna/wew.klamka srebrna(HS)'},
            {name: 'Zew.klamka srebrna/wew.klamka biała(HS)'},
            {name: 'Zew.klamka brązowa/wew.klamka biała(HS)'},
            {name: 'Zew.klamka czarna/wew.klamka czarna(HS)'},
            {name: 'Zew.klamka czarna/wew.klamka biała(HS)'},
        ],
        profiles: ['BIAŁY'],
        doorsteps: [
            'PRÓG I OKAPNIK MAT',
    ...
    types: [
        ...
        handles: [
            ...
            {name: 'Srebrna klamka tylko od wewnątrz'},
            {name: 'BRAK KLAMKI'},
        ...
        doorsteps: [
            'RAMA',
            'PRÓG ALUMINIOWY 20mm (zawiasy drzwiowe)',
            'PRÓG DREWNIANY 36mm - 2 uszczelki',
            'PRÓG DREWNIANY 42mm - 2 uszczelki + zewnętrzne nacięcie pod parapet'
        ],
        openOption: [
            'na zewnątrz'
        ],
